...
import Snap.Machine.Step (Step, Transition(..), pureish, kcomposeish)
import Snap.Machine.Step (foldTransition, mapS) as Step
...
compose m1m2 = uncurry kcomposeish <<< (m1m2 <<*>> _)

identity :: ∀ a. Machine Unit a a
identity = pure pureish
